...
@@ -76,510 +62,185 @@ export default function AdminScorePage() {
.select("*")
...
className={`grid gap-2 border-b border-white/10 px-4 py-3 text-xs uppercase tracking-[0.2em] text-zinc-500 ${
         showSet3
@@ -594,57 +255,53 @@ function LiveScorePreview({ match, compact = false }: { match: Match; compact?:
...
@@ -659,76 +316,3 @@ function PublicScoreRow({
</div>
);
}
